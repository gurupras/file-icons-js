 ...
 * @author    Guru Prasad Srinivasa, <gurupras@buffalo.edu>
 * Originally forked from https://github.com/websemantics/file-icons-js
 */
...
var icondb = [
  ...
  [[['binary-icon', ['dark-green', 'dark-green'], /\.swp$/i, 4],
    ...
    ['image-icon', ['medium-cyan', 'medium-cyan'], /\.fits?$|\.fts$/i,, false,,,, /^SIMPLE {2}=/],
